...
const BlockItem = memo<{ index: number; style: React.CSSProperties; data: ItemData }>(
  ({ index, style, data }) => {
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => data.onToggle(block.id)}
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    onClick={() => data.onDelete(block.id)}
...
const VirtualizedBlockList = memo<VirtualizedBlockListProps>(({
  blocks,
  onEdit,
  onToggle,
  onDelete,
  ...
  const itemData = useMemo(() => ({
    ...
    onDelete,
    onPreview
  }), [blocks, onEdit, onToggle, onDelete, onPreview]);
