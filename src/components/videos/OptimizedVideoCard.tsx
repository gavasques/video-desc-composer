...
const OptimizedVideoCard = memo<VideoCardProps>(({
  video,
  ...
  const handleViewDescription = useCallback(() => {
    onViewDescription(video);
  }, [onViewDescription, video]);

  const handlePreviewBlocks = useCallback(() => {
    onPreviewBlocks(video);
  }, [onPreviewBlocks, video]);
  ...
  return (
    ...
    prevProps.video.autoUpdate === nextProps.video.autoUpdate &&
    prevProps.appliedGeneralBlocks.length === nextProps.appliedGeneralBlocks.length &&
    prevProps.specificBlocks.length === nextProps.specificBlocks.length &&
