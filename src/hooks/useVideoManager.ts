...
export const useVideoManager = () => {
  ...
  const handleCreateBlock = (formData: BlockFormData, editingBlocksVideo: VideoData) => {
  ...
  const handleUpdateBlock = (editingBlock: Block, formData: BlockFormData, editingBlocksVideo: VideoData) => {
  ...
  const handleDeleteSpecificBlock = (blockId: string, editingBlocksVideo: VideoData) => {
    setVideos(videos.map(video => {
      if (video.id === editingBlocksVideo.id) {
